...
public class Cw19 extends JFrame {
	...
	private JRadioButton[] safety = {
			new JRadioButton("Guard", false),
			new JRadioButton("Hide", false)
	};
	...
	class CMIL implements ActionListener {
		public void actionPerformed(ActionEvent e) {
			...
			if(actionCommand.equals("Guard"))
				t.setText("Guard the Ice Cream! " +	"Guarding is " + target.getUIClassID());
			else if(actionCommand.equals("Hide"))
				t.setText("Hide the Ice Cream! " + "Is it hidden? " + target.getUIClassID());*/
		}
	}
	public Cw19() {
		ML ml = new ML();
		...
		safety[0].addActionListener(cmil);
		safety[1].setActionCommand("Hide");
		safety[1].setMnemonic(KeyEvent.VK_H);
		safety[1].addActionListener(cmil);
